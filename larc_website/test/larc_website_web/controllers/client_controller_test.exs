defmodule LarcWebsiteWeb.ClientControllerTest do
  use LarcWebsiteWeb.ConnCase

  alias LarcWebsite.Accounts

  @create_attrs %{email_address: "some email_address", first_name: "some first_name", last_name: "some last_name", message: "some message", phone_number: "some phone_number", subject: "some subject"}
